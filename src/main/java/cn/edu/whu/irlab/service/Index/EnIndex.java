...
public class EnIndex {
     ...
     * @param isEnglish 文本是否为中文 中文为true 英文为false
     *                  String initDir  NLPIR的lib文件夹路径
     */
    public void fetchDocuments(String docDir, boolean isEnglish) throws IOException {
    ...
    public void writeMap(){
        ...
        String fileName1 = "en_invertedindex.txt";
        ...
        String fileName2 = "en_term_id.txt";
        ...
        String fileName3 = "en_term_idf.txt";
        ...
        String fileName4 = "en_docId_Name.txt";
    ...
    public void writeDocuments() {
        ...
        try {
            ...
            FileWriter fw = new FileWriter(new File("results//en_processed.txt"));
